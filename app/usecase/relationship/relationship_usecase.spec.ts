...
import { Friendship, FriendshipStatus, User, UserEmail, Username } from "@domain/model";
import type {
	IPongBallRepository,
...
describe("SendFriendRequestUsecase", () => {
	...
	const requester = User.create(new UserEmail("requester@example.com"), new Username("requester"));
	const receiver = User.create(new UserEmail("receiver@example.com"), new Username("receiver"));
...
describe("RespondToFriendRequestUsecase", () => {
	...
	const requester = User.create(new UserEmail("requester@example.com"), new Username("requester"));
	const receiver = User.create(new UserEmail("receiver@example.com"), new Username("receiver"));
	const otherUser = User.create(new UserEmail("other@example.com"), new Username("other"));
...
describe("GetFriendsUsecase", () => {
	...
	const user = User.create(new UserEmail("user@example.com"), new Username("user"));
	const friend1 = User.create(new UserEmail("friend1@example.com"), new Username("friend1"));
	const friend2 = User.create(new UserEmail("friend2@example.com"), new Username("friend2"));
...
describe("RemoveFriendUsecase", () => {
	...
	const user = User.create(new UserEmail("user@example.com"), new Username("user"));
	const friend = User.create(new UserEmail("friend@example.com"), new Username("friend"));
...
describe("BlockUserUsecase", () => {
	...
	const blocker = User.create(new UserEmail("blocker@example.com"), new Username("blocker"));
	const blocked = User.create(new UserEmail("blocked@example.com"), new Username("blocked"));
